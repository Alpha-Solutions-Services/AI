...
export function SpeakingOrb({
  ...
  return (
    ...
    >
      ...
      >
        <svg viewBox="0 0 344 344" style={{ ["--i" as string]: 0, ["--j" as string]: 0 }}>
          <g id="out1">
        ...
        <svg viewBox="0 0 344 344" style={{ ["--i" as string]: 1, ["--j" as string]: 1 }}>
          <g id="out2">
            <path
              fill="#00FFFF"
        ...
        <svg viewBox="0 0 344 344" style={{ ["--i" as string]: 0, ["--j" as string]: 2 }}>
          <g id="inner3">
            <path
              fill="#00FFFF"
        ...
        <svg viewBox="0 0 344 344" style={{ ["--i" as string]: 1, ["--j" as string]: 3 }}>
          <g id="inner1">
            <path
              fill="#00FFFF"
              fillRule="evenodd"
        ...
        <svg viewBox="0 0 344 344" style={{ ["--i" as string]: 2, ["--j" as string]: 4 }}>
          <path
            fill="#FFD54F"
